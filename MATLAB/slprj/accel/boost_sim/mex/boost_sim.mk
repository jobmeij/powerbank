...
MODEL                   = boost_sim
MODULES                 = boost_sim_acc.c boost_sim_acc_data.c rtGetInf.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\boost_sim_acc.mexw64
MAKEFILE                = boost_sim.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2025b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2025b
START_DIR               = C:\Users\jobme\Documents\GitHub\powerbank\MATLAB
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 21
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:boost_sim_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
boost_sim_acc.obj : $(START_DIR)\slprj\accel\boost_sim\boost_sim_acc.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\boost_sim\boost_sim_acc.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\boost_sim\boost_sim_acc.c

boost_sim_acc_data.obj : $(START_DIR)\slprj\accel\boost_sim\boost_sim_acc_data.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\boost_sim\boost_sim_acc_data.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\boost_sim\boost_sim_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\boost_sim\rtGetInf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\boost_sim\rtGetInf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\boost_sim\rtGetInf.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\boost_sim\rt_nonfinite.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\boost_sim\rt_nonfinite.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\boost_sim\rt_nonfinite.c
