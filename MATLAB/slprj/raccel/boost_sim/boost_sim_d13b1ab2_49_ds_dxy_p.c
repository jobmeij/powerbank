...
mDXY_P . mNumCol = 18ULL ; out -> mDXY_P . mNumRow = 7ULL ; out -> mDXY_P .
...
_cg_const_1 [ 18 ] ; out -> mDXY_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
...
mDXY_P . mIr [ 31 ] = _cg_const_2 [ 31 ] ; ( void ) sys ; ( void ) out ;
return 0 ; }
