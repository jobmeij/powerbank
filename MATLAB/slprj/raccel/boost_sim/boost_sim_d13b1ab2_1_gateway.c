...
SscLoggingSettingTag ) 0 , 685286720.0 , FALSE , FALSE , FALSE } ;
...
, & modelparams , & solverparams ) ; nesl_register_simulator_group ( "boost_sim/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 1 , rtpDaes , 0 , rtwLogDaes , 0 , solverHitDaes ) ; }
