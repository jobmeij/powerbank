...
_cg_const_2 [ 24 ] = { 11 , 10 , 11 , 11 , 10 , 11 , 16 , 10 , 16 , 11 , 14 ,
14 , 10 , 11 , 10 , 11 , 16 , 10 , 11 , 11 , 11 , 14 , 14 , 16 } ; static
int32_T _cg_const_1 [ 19 ] = { 0 , 1 , 3 , 4 , 7 , 9 , 11 , 12 , 12 , 12 , 12
, 14 , 17 , 19 , 19 , 20 , 22 , 23 , 24 } ; ( void ) t1 ; out -> mDXF_P .
mNumCol = 18ULL ; out -> mDXF_P . mNumRow = 18ULL ; out -> mDXF_P . mJc [ 0 ]
...
_cg_const_1 [ 18 ] ; out -> mDXF_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
...
_cg_const_2 [ 23 ] ; ( void ) sys ; ( void ) out ; return 0 ; }
