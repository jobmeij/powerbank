...
1 , 1 , 1 } ; ( void ) t1 ; out -> mTDXY_P . mNumCol = 14ULL ; out -> mTDXY_P
. mNumRow = 3ULL ; out -> mTDXY_P . mJc [ 0 ] = _cg_const_1 [ 0 ] ; out ->
mTDXY_P . mJc [ 1 ] = _cg_const_1 [ 1 ] ; out -> mTDXY_P . mJc [ 2 ] =
...
_cg_const_2 [ 8 ] ; out -> mTDXY_P . mIr [ 9 ] = _cg_const_2 [ 9 ] ; ( void )
